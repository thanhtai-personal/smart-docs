...
function MediaCardNode(props: any) {
  ...
  return (
    <div className="custom-node expand-frame" id={`node-frame-${id}`}>
      ...
      <div className="custom-node__body expand-anim"
        style={{ height: open ? "auto" : "0px", padding: open ? "10px" : "0", overflow: "hidden", background: "rgba(100, 0, 155, 0.45)" }}
      >
        {data.mdContent && open && <div style={{ zIndex: 99999 }}>
